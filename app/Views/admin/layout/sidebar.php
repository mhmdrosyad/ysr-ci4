            ...
            <div class="sidebar-start">
                <div class="sidebar-head">
                    <a href="/" class="logo-wrapper" title="Home">
                        <img src="/landing-page/images/logo-yayasan.png" width="140">
            ...
            <!-- <div class="sidebar-footer">
                <a href="##" class="sidebar-user">
                    <span class="sidebar-user-img">
                        <picture>
                            <source srcset="/admin-page/img/avatar/avatar-illustrated-01.webp" type="image/webp"><img src="/admin-page/img/avatar/avatar-illustrated-01.png" alt="User name">
                        </picture>
                    </span>
