                                ...
                                <td>
                                    <label class="users-table__checkbox">
                                        ...
                                        <div class="categories-table-img">
                                            <picture>
                                                <source srcset="/admin-page/img/categories/01.webp" type="image/webp"><img src="/admin-page/img/categories/01.jpg" alt="category">
                                            </picture>
                                        </div>
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label class="users-table__checkbox">
                                        ...
                                        <div class="categories-table-img">
                                            <picture>
                                                <source srcset="/admin-page/img/categories/02.webp" type="image/webp"><img src="/admin-page/img/categories/02.jpg" alt="category">
                                            </picture>
                                        </div>
                                    </label>
                                </td>
                                ...
                                <td>
                                    <div class="pages-table-img">
                                        <picture>
                                            <source srcset="/admin-page/img/avatar/avatar-face-03.webp" type="image/webp"><img src="/admin-page/img/avatar/avatar-face-03.png" alt="User Name">
                                        </picture>
                                        Annette Black
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label class="users-table__checkbox">
                                        ...
                                        <div class="categories-table-img">
                                            <picture>
                                                <source srcset="/admin-page/img/categories/03.webp" type="image/webp"><img src="/admin-page/img/categories/03.jpg" alt="category">
                                            </picture>
                                        </div>
                                    </label>
                                </td>
                                ...
                                <td>
                                    <div class="pages-table-img">
                                        <picture>
                                            <source srcset="/admin-page/img/avatar/avatar-face-02.webp" type="image/webp"><img src="/admin-page/img/avatar/avatar-face-02.png" alt="User Name">
                                        </picture>
                                        Kathryn Murphy
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label class="users-table__checkbox">
                                        ...
                                        <div class="categories-table-img">
                                            <picture>
                                                <source srcset="/admin-page/img/categories/04.webp" type="image/webp"><img src="/admin-page/img/categories/04.jpg" alt="category">
                                            </picture>
                                        </div>
                                    </label>
                                </td>
                                ...
                                <td>
                                    <div class="pages-table-img">
                                        <picture>
                                            <source srcset="/admin-page/img/avatar/avatar-face-05.webp" type="image/webp"><img src="/admin-page/img/avatar/avatar-face-05.png" alt="User Name">
                                        </picture>
                                        Guy Hawkins
                                    </div>
                                </td>
